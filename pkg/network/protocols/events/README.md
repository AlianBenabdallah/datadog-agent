...
side and it's the caller responsibility to make the conversion (I plan to bring
that into the library once Go generics is available to us) and to copy the data,
*since the memory in the byte slice is reclaimed after the callback execution*.
